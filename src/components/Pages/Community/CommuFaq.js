    ...
    <div className="CommuSection">
      ...
      <div className="CommuRight">
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(0)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 0 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 0 && (
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(1)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 1 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 1 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(2)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 2 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 2 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(3)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 3 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 3 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(4)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 4 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 4 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(5)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 5 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 5 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
        ...
        <div className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(6)}>
          ...
          <div className={`CommuFaqArrow ${activeIndex === 6 ? 'arrowRotate' : ''}`}></div>
        </div>
        {activeIndex === 6 && (
          <div className="CommuFaqQuestionAnswer">
            <h1>A</h1>
...
//           <div key={index} className="CommuFaqQuestion" onClick={() => toggleAnswerVisibility(index)}>
//             <div className="CommuFaqQuestionLeft">
//               <h1>Q</h1>
//               <p>{`질문 ${index + 1}`}</p>
//             </div>
//             <div className={`CommuFaqArrow ${activeIndex === index ? 'arrowRotate' : ''}`}></div>
//           </div>
//         ))}

//         {activeIndex !== null && (
//           <div className={`CommuFaqQuestionAnswer ${activeIndex !== null ? 'active' : ''}`}>
//             <h1>A</h1>
//             <p>{`답변 ${activeIndex + 1}`}</p>
//           </div>
//         )}
//       </div>
//     </div>
