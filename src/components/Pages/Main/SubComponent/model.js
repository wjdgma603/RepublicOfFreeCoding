...
import loginBook from "../images/2d/loginBook.png" // 로그인
...
const Palace = () => {
    ...
    const helper = new THREE.PointLightHelper(PointLight9, 10)

    
    scene.add(PointLight,PointLight1,PointLight2,PointLight3,
        PointLight6,PointLight7,PointLight8,
        PointLight9,PointLight10,PointLight11,PointLight12
        ,helper);
    ...
    // // Ebook 왼쪽
    // const section111 = new THREE.BoxGeometry(200,100,1)
    // const EbookPush = imgPush.load(Ebook)
    // const section1111 = new THREE.MeshStandardMaterial({
    //     map : EbookPush
    // }) 
    // const mesh11 = new THREE.Mesh(section111, section1111)
    // mesh11.position.set(0,70,-222)
    // // Ebook 중앙
    // const section112 = new THREE.BoxGeometry(200,100,1)
    // const EbookPush = imgPush.load(Ebook)
    // const section1212 = new THREE.MeshStandardMaterial({
    //     map : EbookPush
    // }) 
    // const mesh12 = new THREE.Mesh(section112, section1212)
    // mesh12.position.set(0,70,-222)
    // // Ebook 오른쪽
    // const section113 = new THREE.BoxGeometry(200,100,1)
    // const EbookPush = imgPush.load(Ebook)
    // const section1313 = new THREE.MeshStandardMaterial({
    //     map : EbookPush
    // }) 
    // const mesh13 = new THREE.Mesh(section113, section1313)
    // mesh13.position.set(0,70,-222)
   ...
   mesh21.position.set(-250,7,10)
    ...
    scene.add(mesh1,mesh2,mesh3,mesh4,mesh5,mesh6,mesh7,mesh8,mesh9,mesh10
        ,mesh14,mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,
        );
